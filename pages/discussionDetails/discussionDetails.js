...
Page({
            ...
            case "answer":
                {
                    ...
                    if (likeFlag) operator = -1;
                    this.setData({
                        "discussionContent.answer.liked": this.data.discussionContent.answer.liked + 1 * operator,
            ...
            case "comments":
                {
                    ...
                    if (likeFlag) operator = -1;
                    this.setData({
                        [`comments.commentList[${index}].liked`]: this.data.comments.commentList[index].liked + 1 * operator,
    ...
    onLoad(res) {
        ...
        console.log("[INFO] we got a data from the index: ", res);
