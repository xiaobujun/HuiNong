...
Page({
            ...
            case "question":
                {
                    ...
                    this.setData({
                        "discussionContent.question.liked": this.data.discussionContent.question.liked + 1 * operator,
            ...
            case "comments":
                {
                    ...
                    console.log("[DEBUG] commentLike index: " + index);
                    likeFlag = this.data.discussionContent.answer[index].likeStatus;
                    if (likeFlag) operator = -1;
                    this.setData({
                        [`discussionContent.answer[${index}].liked`]: this.data.discussionContent.answer[index].liked + 1 * operator,
                        [`discussionContent.answer[${index}].likeStatus`]: !likeFlag,
                    });
            ...
            case "replies":
                {
                    ...
                    if (likeFlag) operator = -1;
                    this.setData({
                        [`comments.commentList[${fidx}].replies[${index}].liked`]: this.data.comments.commentList[fidx].replies[index].liked +
                            1 * operator,
    ...
    decodeComment() {
        ...
        // 给 discusstionContent.answer 数组追加 likeStatus: false
        let commentBP = this.data.discussionContent;
        for (let i = 0; i < this.data.answerLength; i++) {
            commentBP.answer[i].likeStatus = false;
        }
        console.log("[DEBUG] here is decodeComment got data:", commentBP);
    },
    onReady() {
        // this.decodeComment();
    },
